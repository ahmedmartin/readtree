...
public class books_adapt extends ArrayAdapter {
    Activity conext;
    ArrayList <String> name;
    ArrayList <Uri> image;

    public books_adapt(Activity context, ArrayList <String> name, ArrayList <Uri> image) {
        super(context, R.layout.grid_show, image);
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if(view ==null){
            ...
            view =inflater.inflate(R.layout.grid_show,parent,false);
